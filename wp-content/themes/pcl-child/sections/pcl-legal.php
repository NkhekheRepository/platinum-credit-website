...
/**
 * Title: Legal Footer
 * Description: Regulatory disclosure and CBL compliance text.
 * Categories: pcl
...
<!-- wp:paragraph {"fontSize":"small"} -->
<p class="has-small-font-size">&copy; <?php echo esc_html( date( 'Y' ) ); ?> Platinum Credit Ltd. All rights reserved.</p>
<!-- /wp:paragraph -->
</div>
<!-- /wp:column -->
<!-- wp:column {"verticalAlignment":"center","width":"50%"} -->
