...
define( 'PCL_CHILD_VERSION', '1.3.0' );
...
function pcl_custom_nav() {
	...
	<nav id="mainNav" class="pcl-site-nav" role="navigation" aria-label="<?php esc_attr_e( 'Primary Navigation', 'pcl-child' ); ?>">
	  <div class="pcl-nav-in">
	    ...
	    <button class="pcl-menu-btn" aria-expanded="false" aria-controls="pcl-navlinks" type="button">Menu</button>
	    <div class="pcl-nav-links" id="pcl-navlinks">
	      <a href="#about">Who We Are</a>
	      <a href="#loans">Products</a>
	      <a href="#how">How It Works</a>
	      <a href="#estimator">Estimator</a>
	      <a href="#affordability">Affordability</a>
	      <a href="#contact">Contact</a>
	      <a href="#contact" class="pcl-btn pcl-btn-brand pcl-nav-cta">Apply Now</a>
	    </div>
	  </div>
	</nav>
	<?php
